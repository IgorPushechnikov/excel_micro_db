...
class ImportManager:
    ...
    def perform_import_raw_data(self, file_path: str, db_path: str, progress_callback: Optional[Callable[[int, str], None]] = None) -> bool:
        """
        ...
        try:
            ...
            success = import_raw_data_from_excel(storage, file_path, options=None)
    ...
    def perform_import_styles(self, file_path: str, db_path: str, progress_callback: Optional[Callable[[int, str], None]] = None) -> bool:
        """
        ...
        try:
            ...
            success = import_styles_from_excel(storage, file_path, options=None)
    ...
    def perform_import_charts(self, file_path: str, db_path: str, progress_callback: Optional[Callable[[int, str], None]] = None) -> bool:
        """
        ...
        try:
            ...
            success = import_charts_from_excel(storage, file_path, options=None)
    ...
    def perform_import_formulas(self, file_path: str, db_path: str, progress_callback: Optional[Callable[[int, str], None]] = None) -> bool:
        """
        ...
        try:
            ...
            success = import_formulas_from_excel(storage, file_path, options=None)
    ...
    def perform_import_raw_data_in_chunks(self, file_path: str, db_path: str, progress_callback: Optional[Callable[[int, str], None]] = None) -> bool:
        """
