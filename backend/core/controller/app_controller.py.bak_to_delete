# src/core/controller/app_controller.py
"""
...
# Импорты для новых менеджеров
from .data_manager import DataManager
from .project_manager import ProjectManager
# from .format_manager import FormatManager # Пока не реализован
# from .chart_manager import ChartManager # Пока не реализован
# from .analysis_manager import AnalysisManager # Пока не реализован
# from .export_manager import ExportManager # Пока не реализован
# from .node_manager import NodeManager # Пока не реализован
# from .processor_bridge import ProcessorBridge # Пока не реализован
