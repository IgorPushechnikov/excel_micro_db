  ...
  return (
    <div className="h-screen w-screen flex flex-col bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 p-0 m-0 overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Левая панель (Обозреватель проекта - заглушка) */}
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex flex-1 overflow-hidden">
            {/* Таблица (2/3 ширины правой панели) - исправлено на flex-1 */}
            <div className="flex-1 border-r border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800">
              <DataTable />
            </div>
      ...
      {/* Нижняя панель (Функции и Состояние - заглушка для функций) */}
